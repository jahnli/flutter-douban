      ...
      child: Row(
        ...
        children: <Widget>[
          Container(
            margin: EdgeInsets.only(right: ScreenAdapter.width(20)),
            child: ClipRRect(
              child: Image.network('${_data.pic.normal}',height:ScreenAdapter.height(Configs.thumbHeight(size: 'middle')),width: ScreenAdapter.width(Configs.thumbHeight(size: 'small')),fit: BoxFit.fill),
